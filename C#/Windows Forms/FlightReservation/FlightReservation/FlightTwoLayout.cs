...
namespace FlightReservation
{
    ...
    /// </summary>
    public partial class FlightTwoLayout : UserControl
    {
        /// <summary>
        ...
        /////
        //public static event ButtonClickDelegate ButtonClickEvent;
        private void lbl_seat_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    ///passes the label seleted to the event
        ...
        /// <summary>
        /// Initializes the usercontrol flight two layout
        /// </summary>
        public FlightTwoLayout()
        {
            ///Try executing if problem call HandleError to display the error Message; 
            try
            {
                ///initializes the usercontrol flighttwolayout
                InitializeComponent();
            }
            catch (Exception ex)
            {
